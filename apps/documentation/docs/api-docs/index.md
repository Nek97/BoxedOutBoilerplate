...
<img src="_media/boxedout-mark-square-blue2.png" width="128"/>
...
**NOTE:** to change these configurations, please take a look at [How to configure docker](_media/docker-configuration.md)
...
<img src="_media/docker-resources.png" alt="GitHub Token Scopes" width="40%"/>
<br/>
...
<img src="_media/github-scopes.png" alt="GitHub Token Scopes" width="40%"/>
<br/>
...
- [Application and Library Creation](_media/application-and-library-creation.md)

- [Application architecture](_media/application-architecture.md)

- [Application lifecycle](_media/application-lifecycle.md)

- [Authorization flow](_media/authorization-flow.md)

- [Database Connection Setup](_media/database-connection-setup.md)

- [Database Migration](_media/database-migration.md)

- [Database Seeding](_media/database-seeding.md)

- [Development environment](_media/development-environment.md)

- [Docker Configuration](_media/docker-configuration.md)

- [Error Handling](_media/error-handling.md)

- [Git Workflow and Versioning](_media/git-workflow-and-versioning.md)

- [Knowledge base](_media/knowledge-base.md)

- [Logging](_media/logging.md)

- [Naming conventions](_media/naming-conventions.md)

- [NestJS](_media/nestjs.md)

- [Pipeline](_media/pipeline.md)

- [Querying GraphQL](_media/querying-graphql.md)

- [References](_media/references.md)

- [Testing](_media/testing.md)

### Legacy/Deprecated

- [Legacy Endpoint creation](_media/legacy-endpoint-creation.md)

- [Legacy GraphQL Ag-grid](_media/legacy-graphql-aggrid.md)
