...
1. If the directory does not exist yet, and you're the first to initialize this [Database Module](/docs/creating-new-applications-and-libraries.md). Create a `database.ts` inside a new `config` directory in the module.
