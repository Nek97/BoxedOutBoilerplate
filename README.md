...
<img src="./docs/assets/boxedout-mark-square-blue2.png" width="128"/>
...
**NOTE:** to change these configurations, please take a look at [How to configure docker](./docs/docker-configuration.md)
...
<img src="./docs/assets/docker-resources.png" alt="GitHub Token Scopes" width="40%"/>
<br/>
...
<img src="./docs/assets/github-scopes.png" alt="GitHub Token Scopes" width="40%"/>
<br/>
...
- [Application and Library Creation](./docs/application-and-library-creation.md)
...
- [Database Connection Setup](./docs/database-connection-setup.md)
...
- [Git Workflow and Versioning](./docs/git-workflow-and-versioning.md)
...
- [Querying GraphQL](./docs/querying-graphql.md)
...
- [Legacy Endpoint creation](./docs/legacy-endpoint-creation.md)

- [Legacy GraphQL Ag-grid](./docs/legacy-graphql-aggrid.md)
